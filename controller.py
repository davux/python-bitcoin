    ...
    def __new__(cls, user='', password='', host='127.0.0.1', port=8332, protocol='http'):
        if ('' == user) and (0 != len(cls.cache)):
            ...
            if not url in cls.cache:
                ...
                cls.cache[url].getaddressesbylabel = cls.cache[url].conn.getaddressesbylabel
                ...
                cls.cache[url].getlabel = cls.cache[url].conn.getlabel
                cls.cache[url].setlabel = cls.cache[url].conn.setlabel
                ...
                cls.cache[url].getreceivedbylabel = cls.cache[url].conn.getreceivedbylabel
                cls.cache[url].help = cls.cache[url].conn.help
                cls.cache[url].listreceivedbyaddress = cls.cache[url].conn.listreceivedbyaddress
                cls.cache[url].listreceivedbylabel = cls.cache[url].conn.listreceivedbylabel
